...
DROP TABLE IF EXISTS public.overlay_device_revoke_receipts CASCADE;
DROP TABLE IF EXISTS public.overlay_device_sessions CASCADE;
DROP TABLE IF EXISTS public.overlay_device_credentials CASCADE;
