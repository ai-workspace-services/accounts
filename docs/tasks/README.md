...
| 日期 | 任务 | 状态 | 关联 PR |
|---|---|---|---|
| 2026-07-14 | [高级服务就绪度门禁(邮箱+密码+MFA)+ 渐进引导](2026-07-14-advanced-service-readiness-gate.md) | ⏳ 代码完成待合并(栈式依赖 #24,需 console 配套) | accounts 本 PR(base #24) |
| 2026-07-14 | [OAuth 登录后邮箱验证门禁 + trial 激活](2026-07-14-oauth-email-verify-gate.md) | ⏳ 代码完成待合并(需 console 配套) | accounts [#24](https://github.com/ai-workspace-services/accounts/pull/24) |
